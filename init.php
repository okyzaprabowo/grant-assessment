<?php
/**
 * Plugin Name:  Grant Application Tool
 * Plugin URI:   http://www.blenderbox.com
 * Description:  Drag & drop your grant picker based on Questions. Developed for The Harry and Jeanette Weinberg Foundation
 * Version:      1.0.0 beta 1
 * Author:       Blenderbox, Inc.
 * Author URI:   http://www.blenderbox.com
 * Author Email: omaherdi@blenderbox.com
 * License:      GPLv2+
...
class Questions_Init {
	...
	public static function register_plugin_styles() {
		...
		wp_enqueue_style( 'questions-plugin-styles', QUESTIONS_URLPATH . '/includes/css/animate.css' );
