...
class Questions_Core extends Questions_Component{
	...
	public function custom_post_types(){
		...
		$args_post_type = array(
			'labels' => array(
				'name' => __( 'Pickers', 'questions-locale' ),
				'singular_name' => __( 'Picker', 'questions-locale' ),
				'all_items' => __( 'All Pickers', 'questions-locale' ),
				'add_new_item' => __( 'Add new Picker', 'questions-locale' ),
				'edit_item' => __( 'Edit Picker', 'questions-locale' ),
				'new_item' => __( 'Add new Picker', 'questions-locale' ),
				'view_item' => __( 'View Picker', 'questions-locale' ),
				'search_items' => __( 'Search Picker', 'questions-locale' ),
				'not_found' => __( 'No Picker available', 'questions-locale' ),
				'not_found_in_trash' => __( 'No Picker available', 'questions-locale' )
			),
			'public' => TRUE,
			'has_archive' => TRUE,
